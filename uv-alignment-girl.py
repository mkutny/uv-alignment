...
# select skinned eyes
eyes = bpy.data.objects["GirlEyes"]
...
applyGirlTransformation (eyes_obj)
...
camera_origin = scene.objects.get('cam_girl').location
...
photo_plane = scene.objects.get('GirlFotoPlane')
